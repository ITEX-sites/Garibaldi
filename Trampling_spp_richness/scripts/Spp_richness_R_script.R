...
pf_data <- read.table("./data/trampling_compiled_final.csv", header=TRUE, sep =",", dec = ".")
...
write.csv(pf_data, file = "./data/cleaned_ssp_richness.csv")
...
pfdata <- read.csv("./data/cleaned_ssp_richness.csv", header=TRUE)
...
#write files to csv
write.csv(species.data, file = "./data/garibaldi_pf_species_matrix.csv")
write.csv(site.data, file = "./data/garibaldi_pf_site_matrix.csv")
